  ...
  "content": [
    {
      ...
      "response": {
        ...
        "choices": [
          {
            "kind": "item",
            "text": "{{MuseumPart}} *operator=(const {{MuseumPart}} &rhs) {",
            "forced": false
          },
          {
            "kind": "item",
