...
describe('FITB-Drop Response Groups', () => {
  ...
  it('Drag/Drop Within Q1', () => {
    ...
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_1").find('.examma-ray-fitb-drop-bank *[data-examma-ray-fitb-drop-id="item2"]').trigger("pointerdown", {button: 0});
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_1").find('.sortable-chosen').trigger("dragstart");
    cy.wait(100);
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_1").find('.examma-ray-fitb-drop-location').last().trigger("dragenter");
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_1").find('.sortable-chosen.sortable-ghost > *').first().trigger("drop");
  ...
  it('Drag/Drop Prohibited From Q1 to Q2', () => {
    ...
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_1").find('.sortable-chosen').trigger("dragstart");
    cy.wait(100);
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_2").find('.examma-ray-fitb-drop-location').last().trigger("dragenter");
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_1").find('.sortable-chosen.sortable-ghost > *').first().trigger("drop");
  ...
  it('Drag/Drop From Reference Q1 Bank to Q1', () => {
    ...
    cy.get(bank).find('*[data-examma-ray-fitb-drop-id="item2"]').trigger("pointerdown", {button: 0});
    cy.get(bank).find('.sortable-chosen').trigger("dragstart");
    cy.wait(100);
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_1").find('.examma-ray-fitb-drop-location').last().trigger("dragenter");
  ...
  it('Drag/Drop Prohibited From Reference Q2 Bank to Q3', () => {
    ...
    cy.get(bank).find('.sortable-chosen').trigger("dragstart");
    cy.wait(100);
    responseElem("test-fitb-drop-reference-q-fitb_drop_test_3").find('.examma-ray-fitb-drop-location').last().trigger("dragenter");
    cy.get('.sortable-chosen.sortable-ghost > *').first().trigger("drop");
