...
// import { CodeWritingRubricResult, CodeWritingRubricItem, CodeWritingRubricItemStatus } from "../graders/CodeWritingGrader"
...
// export type CodeWritingGradingAssignment = GradingAssignmentSpecification<ResponseKind, CodeWritingRubricResult>;
// export type CodeWritingGradingGroup = GradingGroup<ResponseKind, CodeWritingRubricResult>;
...
//   autograder: (ex: Exercise) => CodeWritingRubricResult,
...
//   private autograder: (ex: Exercise) => CodeWritingRubricResult;
...
//       grading_result: CodeWritingRubricResult | undefined
//     }) {
...
//   private updateRubricItemButtons(gr: CodeWritingRubricResult | undefined) {
...
//   private updateGradingFinishedButton(gr: CodeWritingRubricResult | undefined) {
...
//   private pointsEarned(gr?: CodeWritingRubricResult) {
//     if (!gr) {
//       return 0;
//     }
...
// function areEquivalentGradingResults(gr1: CodeWritingRubricResult | undefined, gr2: CodeWritingRubricResult | undefined) {
//   return deepEqual(gr1, gr2);
// }

// function createEmptyGradingResult(group: CodeWritingGradingGroup) : CodeWritingRubricResult {
//   return {
...
// function copyGradingResult(gr: CodeWritingRubricResult | undefined) {
//   if (gr === undefined) {
//     return undefined;
//   }
