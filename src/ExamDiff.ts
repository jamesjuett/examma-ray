import { ExamComponentSpecification, ExamSpecification, QuestionSpecification, SectionChooserSpecification, SectionSpecification } from "./core/exam_specification";
...
export namespace ExamDiff {
  ...
  export function shallowCopy<T extends ExamComponentSpecification = ExamComponentSpecification>(spec: ExamComponentSpecification) : ShallowSpecification<T> {
  ...
  function shallowReplacement(obj: ReplaceableComponent | ReplaceableComponent[]) : {} {
    ...
    obj.component_kind ? shallowCopy(<ExamComponentSpecification>obj) :
    obj;
  }
  ...
  type ExamComponentDiff<T extends ExamComponentSpecification> = Partial<Record<keyof T, boolean>>;

  export function shallowDiff<T extends ExamComponentSpecification>(spec1: T, spec2: T) : ExamComponentDiff<T> | undefined {
