...
//   /**
//    * Returns whether or not this verifier can be used for the given question
//    * @param responseKind 
//    */
//   isVerifier<T extends ResponseKind>(question: Question<T>): this is QuestionVerifier<T>;
...
//    * @param elem The HTML element for the status badge.
//    */
//   annotateResponseElem(aq: AssignedQuestion<RK>, response_elem: JQuery) : void;
