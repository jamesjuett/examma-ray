...
import { AssignedExam, AssignedQuestion, DEFAULT_SAVER_MESSAGE_GRADESCOPE, Exam, Question, RANDOM_BY_TAG, RenderMode, Section } from "./autograder";
...
exam.addSection(new Section({
  ...
  "mk_saver_message": DEFAULT_SAVER_MESSAGE_GRADESCOPE,
  "builder": [
